...
public interface OrderItemRepository extends JpaRepository<OrderItem,Integer> {
    ...
    @Query("select new com.sisyphe.bookstore.entity.entityComp.BookComp(o.book_id,count(o.book_id)) from OrderItem o where o.timestamp>=:lower_time and o.timestamp<=:upper_time group by o.book_id order by count(o.book_id) desc")
